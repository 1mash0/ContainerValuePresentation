//
//  ContainerValuePresentationApp.swift
//
...
@main
struct ContainerValuePresentationApp: App {
    ...
    var body: some Scene {
        ...
        .setupAsPresentationWindow(Self.configuration.slideIndexController) {
            openWindow(id: "ContainerValuePresentation")
        }
        ...
        WindowGroup(id: "ContainerValuePresentation") {
            macOSPresenterView(
